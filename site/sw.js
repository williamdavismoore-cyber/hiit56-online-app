...
const CACHE_NAME = 'ndyra-static-cp34-v1';
...
// Offline fallback is allowed, but cache should never “win” while online.
...
self.addEventListener('fetch', (event) => {
  ...
  // Always fetch these fresh (offline fallback only).
